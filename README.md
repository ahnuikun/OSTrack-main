...
- GOT10K-test
```
python tracking/test.py ostrack vitb_384_mae_ce_32x4_got10k_ep100 --dataset_name got10k_test --threads 16 --num_gpus 4
python lib/test/utils/transform_got10k.py --tracker_name ostrack --cfg_name vitb_384_mae_ce_32x4_got10k_ep100
```
- TrackingNet
```
python tracking/test.py ostrack vitb_384_mae_ce_32x4_ep300 --dataset_name trackingnet --threads 16 --num_gpus 4
...
```
python tracking/test.py ostrack vitb_384_mae_ce_32x4_ep300 --dataset_name vot22 --threads 1 --num_gpus 1 --debug 1
```
